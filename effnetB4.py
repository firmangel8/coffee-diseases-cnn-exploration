...
efficientNet = efn.EfficientNetB4(weights='imagenet' )
...
log_dir = "logs-effnet-b4/fit/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir)
callback_list = [learning_rate_reduction, tensorboard_callback]
